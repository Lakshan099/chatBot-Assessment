...
public class Test extends javax.swing.JFrame {
    ...
    public Test() {
        ...
        c.setTitle("Java Swing Chat");
        SimpleDateFormat df = new SimpleDateFormat("dd/MM/yyyy, hh:mmaa");
        c.addChatEvent(new ChatEvent() {
            @Override
            public void mousePressedSendButton(ActionEvent evt) {
                Icon icon = new ImageIcon(getClass().getResource("/test/p1.png"));
                String name = "Ra Ven";
                String date = df.format(new Date());
                String message = c.getText().trim();
                c.addChatBox(new ModelMessage(icon, name, date, message), ChatBox.BoxType.RIGHT);
                c.clearTextAndGrabFocus();
            }
